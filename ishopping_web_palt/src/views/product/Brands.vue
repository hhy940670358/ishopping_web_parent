	...
	<section>
		...
		<el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
			<el-form :inline="true" :model="filters">
				<el-form-item>
					<!--通过keyword查询 可以从多个字段查询-->
					<!--绑定filters中的keyword 这样输入变化，filters中的keyword也就变化了 -->
		...
		<el-table :data="brands" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
			...
			<el-table-column prop="englishName" label="英文名" width="250"  sortable>
			</el-table-column>
			<el-table-column prop="description" label="描述" width="280" sortable>
			</el-table-column>
			<el-table-column prop="productType.name" label="产品类型"  min-width="200" sortable>
			</el-table-column>
